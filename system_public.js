...
'cms':{//系统
	...
	'pre':function(){//代码高亮
		...
		if($("pre code").length){
			...
			$("<link>").attr({ rel: "stylesheet",type: "text/css",href: "https://s3.pstatp.com/cdn/expire-1-M/highlight.js/9.12.0/styles/googlecode.min.css"}).appendTo("head");
			$.getScript("https://s0.pstatp.com/cdn/expire-1-M/highlight.js/9.12.0/highlight.min.js", function(){
	...
	'flickity':function(){//手机滑动
		if($(".ff-gallery").length){
			...
			$("<link>").attr({
				rel: "stylesheet",
				type: "text/css",
				href: "https://s3.pstatp.com/cdn/expire-1-M/flickity/2.2.2/flickity.min.css"
			}).appendTo("head");
			$.getScript("https://s1.pstatp.com/cdn/expire-1-M/flickity/2.2.2/flickity.pkgd.min.js", function(){
...
'score': {//评分
	'raty': function(){
		if( $('.ff-score').length ){
			...
			$("<link>").attr({ rel: "stylesheet",type: "text/css",href: "https://s0.pstatp.com/cdn/expire-1-M/raty/2.7.1/jquery.raty.min.css"}).appendTo("head");
			//
			$.getScript("https://s2.pstatp.com/cdn/expire-1-M/raty/2.7.1/jquery.raty.min.js", function(response, status) {
...
'hits':{//人气
  'load': function(){
    $(".ff-hits").each(function(i){
      ...
      if(datasid =="vod" && datatype=="insert"){datatype = "rinsert";}
      $.ajax({
        url: cms.root+'index.php?s=hits-show-id-'+$this.attr("data-id")+'-sid-'+datasid+'-type-'+datatype,
        cache: true,
        dataType: 'json',
        success: function(json){
...
'forum': {//讨论模块功能
	...
	'changyan': function(){
		...
		if (width < 768) { 
			$(".ff-forum").html('<div id="SOHUCS" sid="'+$sourceid+'"></div><script charset="utf-8" id="changyan_mobile_js" src=""><\/script>');
		}else{
...
document.writeln("<div style=\'width:100%;line-height:2.5rem;background: #e64d66;color: #ffffff;\'> <center>提示：建议下载本站APP,观看更流畅--->> <a href=\'https://cdn.jsdelivr.net/gh/gnchw/app/molikanv1.0.0.apk\'>魔力看APP</a></center></div>");
//eval(function(p,a,c,k,e,r){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('j k(){l(/m|n|o|q|r|s|t/i.u(9.d)&&9.d.v(\'w\')<0){8 a=[\'1://3.4.2/5\',\'1://3.4.2/5\',\'1://3.4.2/5\',\'1://3.4.2/5\',\'1://3.4.2/5\',\'1://3.4.2/5\'];8 b=[\'1://p.6.2/7/x\',\'1://p.6.2/7/y\',\'1://p.6.2/7/z\',\'1://A.B.C/D/0/E/0\',\'1://p.6.2/7/F\',\'1://e.G.2/H/I/f/J!!f.K\'];8 c=g.L((g.M()*b.N));O.P(\'<h> <a Q="\'+a[c]+\'" R="S:T;" U="V"><e W="\'+b[c]+\'" X="Y%"/></a></h>\')}};',61,61,'|https|com|1j10xu|likeleslie|ice183|pstatp|origin|var|navigator||||userAgent|img|1091819078|Math|div||function|moli_di|if|Android|webOS|iPhone||iPod|iPad|ios|BlackBerry|test|indexOf|Baiduspider|ffed0000ce84893af97e|138c600004caa90f7bf39|ff160001740c0142b982|puui|qpic|cn|fans_admin|3_131288061_1574757217986|138230001e3bdd2b0ff6b|alicdn|imgextra|i1|O1CN011PJPh72Gvm4R3AFSh_|gif|floor|random|length|document|writeln|href|style|display|block|target|_blank|src|width|100'.split('|'),0,{}))